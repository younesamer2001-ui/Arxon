...
import { MouseParallax } from '@/app/components/ui/MouseParallax'
  ...
  return (
    <section ref={heroRef} className="relative overflow-hidden min-h-[100svh] flex items-center justify-center" style={{ background: '#050510' }}>
      ...
      <div className="absolute top-0 left-0 right-0 h-px" style={{ background: `linear-gradient(90deg, transparent, rgba(${goldRgb},0.12), transparent)` }} />
        ...
        // Removed old motion div starting tag in favor of the full replacement block below
        ...
        >
          <MagneticButton
            onClick={ctaClick}
            className="gold-btn gold-btn-pulse rounded-xl py-4 px-10 text-[16px] font-bold inline-flex items-center gap-2 group border-none cursor-pointer text-[#050510]"
          ...
          <MagneticButton
            ...
            className="rounded-xl py-4 px-10 text-[16px] font-bold inline-flex items-center gap-2 group transition-all duration-300 hover:scale-[1.02] cursor-pointer"
      ...
      <MouseParallax className="w-full h-full flex items-center justify-center pb-[10vh] pt-[15vh]">
        <motion.div
          className="relative z-10 w-full max-w-4xl mx-auto px-5 text-center"
        ...
        >
          ...
          <motion.h1
            ...
            className="text-[22px] sm:text-[28px] md:text-[36px] font-semibold leading-snug mb-10 tracking-tight"
            style={{ color: '#f4f1eb', fontFamily: 'var(--font-heading, "Plus Jakarta Sans", sans-serif)' }}
          >
            {(no
              ? 'i uka bruker du på oppgaver AI gjør bedre.'
              : 'a week you spend on tasks AI does better.'
